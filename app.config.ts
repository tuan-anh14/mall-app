...
const API_BASE_URL = process.env.API_BASE_URL ?? 'https://hub-be-dgpi.onrender.com';
...
const appName: Record<string, string> = {
  development: 'ShopHUB (Dev)',
  preview: 'ShopHUB (Preview)',
  production: 'ShopHUB',
};

// Separate bundle IDs per env prevent dev/prod builds conflicting on same device
const bundleId: Record<string, string> = {
  development: 'com.yourcompany.hubapp.dev',
  preview: 'com.yourcompany.hubapp.preview',
  production: 'com.yourcompany.hubapp',
};
